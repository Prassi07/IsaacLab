...
@configclass
class SpotObservationsFlatHsCfg:
...
@configclass
class SpotTerminationsFlatHsCfg:
...
@configclass
class SpotFlatHsEnvCfg(LocomotionVelocityRoughEnvCfg):

    # Basic settings'
    scene: MySceneCfg = MySceneCfg(num_envs = 4096, env_spacing = 2.5)
    observations: SpotObservationsFlatHsCfg = SpotObservationsFlatHsCfg()
    actions: SpotActionsFlatHsCfg = SpotActionsFlatHsCfg()
    commands: SpotCommandsFlatHsCfg = SpotCommandsFlatHsCfg()
    
    # MDP setting
    rewards: SpotRewardsFlatHsCfg = SpotRewardsFlatHsCfg()
    terminations: SpotTerminationsFlatHsCfg = SpotTerminationsFlatHsCfg()
    events: SpotEventFlatHsCfg = SpotEventFlatHsCfg()
    curriculum: SpotCurriculumFlatHsCfg = SpotCurriculumFlatHsCfg()
...
class SpotFlatHsEnvCfg_PLAY(SpotFlatHsEnvCfg):

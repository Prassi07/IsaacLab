...
class SpotCommandsRoughCfg:
    ...
    base_velocity = mdp.UniformVelocityCommandCfg(
        ...
        ranges=mdp.UniformVelocityCommandCfg.Ranges(
            lin_vel_x=(-2.0, 2.0), lin_vel_y=(-1.5, 1.5), ang_vel_z=(-1.0, 1.0)
        ),
    )
...
@configclass
class SpotTerminationsRoughCfg:
...
class SpotRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    # MDP setting
    rewards: SpotRewardsRoughCfg = SpotRewardsRoughCfg()
    terminations: SpotTerminationsRoughCfg = SpotTerminationsRoughCfg()
    events: SpotEventRoughCfg = SpotEventRoughCfg()
